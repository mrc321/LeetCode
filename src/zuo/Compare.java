...
import zuo.structure.AVLTreeMap;
import zuo.structure.SizeBalancedTreeMap;
import zuo.structure.SkipListMap;
...
//            printAll(skip, addK, addV, removeK);
    ...
    public static void printAll(SkipListMap<Integer, Integer> obj, int addK, int addV, int removeK) {
        System.out.println("put -> (" + addK + "," + addV + ")");
        System.out.println("remove -> (" + removeK + ")");
        System.out.println(obj.size());
        for (int i = obj.maxLevel; i >= 0; i--) {
            System.out.print("Level " + i + " : ");
            SkipListMap.Node<Integer, Integer> cur = obj.head;
            while (cur.nextNodes.get(i) != null) {
                SkipListMap.Node<Integer, Integer> next = cur.nextNodes.get(i);
